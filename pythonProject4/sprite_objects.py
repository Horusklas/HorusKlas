...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            'sprite_bochka': {
                'sprite': pygame.image.load('sprite/bochka/stat/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 1.8,
                'scale': 0.4,
                'animation': deque(
                    [pygame.image.load(f'sprite/bochka/anim/{i}.png').convert_alpha() for i in range(12)]),
                'animation_dist': 800,
                'animation_speed': 10,
                'blocked': True,
            },
            ...
            'sprite_fire': {
                'sprite': pygame.image.load('sprite/fire/stat/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': 0.6,
                'animation': deque(
                    [pygame.image.load(f'sprite/fire/anim/{i}.png').convert_alpha() for i in range(16)]),
                'animation_dist': 800,
                'animation_speed': 5,
                'blocked': False,
            },
